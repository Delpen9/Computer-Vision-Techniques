...
def part_1b():
    ...
    # default.
    ps5.part_1b(ps5.KalmanFilter, template_loc, save_frames, fr'{input_dir}/circle')
...
def part_1c():
    ...
    # Define process and measurement arrays if you want to use other than the
    # default.
    ps5.part_1c(ps5.KalmanFilter, template_loc, save_frames, fr'{input_dir}/walking')
...
def part_2a():
    ...
    # Define process and measurement arrays if you want to use other than the
    # default.
    ps5.part_2a(ps5.ParticleFilter, template_loc, save_frames, fr'{input_dir}/circle')
...
def part_2b():
    ...
    # Define process and measurement arrays if you want to use other than the
    # default.
    ps5.part_2b(ps5.ParticleFilter, template_loc, save_frames, fr'{input_dir}/pres_debate_noisy')
...
def part_3():
    ...
    # Define process and measurement arrays if you want to use other than the
    # default.
    ps5.part_3(ps5.AppearanceModelPF, template_rect, save_frames, fr'{input_dir}/pres_debate')
...
def part_4():
    ...
    # Define process and measurement arrays if you want to use other than the
    # default.
    ps5.part_4(ps5.MDParticleFilter, template_rect, save_frames, fr'{input_dir}/pedestrians')
