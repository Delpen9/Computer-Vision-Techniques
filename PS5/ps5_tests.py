...
class PS5_PF_Tests(unittest.TestCase):
    ...
    def test_PF_base_1(self):
        test_path = fr'{input_dir}/input_test/circle/1/'
        template_path = fr'{input_dir}/input_test/circle/template.png'
    ...
    def test_PF_ellipse_1(self):
        test_path = fr'{input_dir}/input_test/ellipse/1/'
        template_path = fr'{input_dir}/input_test/ellipse/template.png'
...
if __name__ == '__main__':
    # unittest.main()
    particle_filter_tester = PS5_PF_Tests()
    particle_filter_tester.test_PF_ellipse_1()
