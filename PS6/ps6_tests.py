...
# I/O directories
INPUT_DIR = fr'{ROOT_DIR}/input_images_part1/input_test'
...
class HaarFeature(unittest.TestCase):
    ...
    def test_integral_images(self):
        ti_path = os.path.join(INPUT_DIR, "test_image_ii.npy")
        ii_path = os.path.join(INPUT_DIR, "integral_image_ii.npy")
...
if __name__ == '__main__':
    # unittest.main()
    haar = HaarFeature()
    haar.test_HaarFeature_evaluate()
