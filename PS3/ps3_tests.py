...
determine if your implementation is correct. However please note that the 
autograder tests are more comprehensive and passing these tests does not guarentee 
that it will pass the autograder. In this collection of tests your code output will be
...
INPUT_DIR = fr'{ROOT_DIR}/input_images/test_images/'
